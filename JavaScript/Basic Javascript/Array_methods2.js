...
// map
// creates a new array with reults of calling a callback on every element in array 

const texts = ['rofl', 'lol', 'omg', 'ttyl'];
const caps = texts.map(function(t){ // map's main purpose is to create and return a new array
...
const price = [9.99, 1.50, 49.99, 30.5]
